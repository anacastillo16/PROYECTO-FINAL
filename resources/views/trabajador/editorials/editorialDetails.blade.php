...
@section('content')
    <div class="body-bg min-vh-100 py-5" style="background-color: #D9E4DD;">
        <main class="container my-5">
            <h2 class="mb-4 text-center text-main fw-bold" style="color: #4A4A4A;">Detalle de la editorial</h2>

            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card shadow p-4" style="background-color: #F7FAF5;">
                        <div class="row g-4">
                            <div class="col-md-8">
                                <h2 class="card-title mb-3 fw-bold" style="color: #406343;">{{ $editorial->name }}</h2>
                                <p class="card-text" style="color: #4A4A4A;"><strong>Dirección:</strong> {{ $editorial->address }}</p>
                                ...
                                <div class="mt-4 d-flex gap-2">
                                    ...
                                    <button type="button" class="button-secondary-custom" style="background-color: #d9534f; color: white;" data-bs-toggle="modal" data-bs-target="#confirmDeleteEditorialModal">
                                        Borrar editorial
                                    </button>
                                ...
                                <div class="modal fade" id="modificarEditorialModal" tabindex="-1" aria-labelledby="modificarEditorialModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-md">
                                        <div class="modal-content" style="background-color: #F7FAF5;">
                                            <div class="modal-header" style="background-color: #6CBF84; color: white;">
                                            ...
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('trabajador.editorials.update', $editorial->id) }}">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="name" class="form-label" style="color: #4A4A4A;">Nombre</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="address" class="form-label" style="color: #4A4A4A;">Dirección</label>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content" style="background-color: #F7FAF5;">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="button-secondary-custom" data-bs-dismiss="modal">
                                                    Cancelar
                                                </button>
