...
@section('content')
    <main class="container my-5 body-bg">
        <h2 class="mb-4 text-center text-main">Detalle del libro</h2>
                ...
                <div class="card shadow p-4" style="background-color: #D9E4DD;">
                    <div class="row g-4">
                        ...
                        <div class="col-md-8 text-main">
                            ...
                            <p>
                                <strong>Autor:</strong>
                                <a href="{{ route('trabajador.autors.show', $book->autor->id) }}" target="_blank" class="text-main" style="text-decoration: underline;">
                            ...
                            <div class="mt-4 d-flex gap-2">
                                ...
                                <button type="button" class="button-secondary-custom" style="background-color: #E26A6A; color: white;" data-bs-toggle="modal"
                                    data-bs-target="#confirmDeleteBookModal">
                                    Borrar
                                </button>

                                <a href="{{ route('index.trabajador') }}" class="button-secondary-custom">Ver libros</a>
                            </div>
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('trabajador.books.update', $book->id) }}">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    ...
                                                    <button type="submit" class="button-primary-custom">Guardar
                                                        cambios</button>
                                                </div>
                                            </form>
                                        </div>
